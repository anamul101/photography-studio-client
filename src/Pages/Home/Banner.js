    ...
    return (
        <div className="hero min-h-screen" style={{ backgroundImage: `url("https://www.instituteofphotography.in/wp-content/uploads/2016/10/instituteofphotography-testimonial-banner.jpg")` }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                ...
                <p className="mb-5">Welcome to the Photography Studio, a place to get the best professional  photography in Bangladesh. Contrary to what most people believe,<br /> photography is a delicate art that combines your creative skills and technical expertise to make pictures come alive.</p>
                <Link to='/services'>
